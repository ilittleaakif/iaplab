...
import { SEMESTRES } from "./main_datas";
import { BookOpen, GraduationCap, MessageCircleMore, Calendar, CalendarDays } from "lucide-react";
...
const LibrarySection = forwardRef((props, ref) => {
  ...
  return (
    <div className="py-10 font-main" ref={ref}>
      ...
      <div className="space-y-12 my-10 mx-auto px-4 md:px-12 max-w-7xl">
