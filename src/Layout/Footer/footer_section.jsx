...
const Footer = () => {
  return (
    <footer className="bg-bg-soft font-main text-text py-10 flex flex-col items-center justify-center select-none">
      ...
      <div className="text-text-soft flex items-center gap-2 text-sm md:text-base">
